 ...
 */
class OauthScopeRequest extends BaseRequest
{
    //验证规则
    protected $rule = [
        //@validate
		"id"=>"integer|gt:0|length:0,20",
		"scope"=>"alphaDash|length:0,255",
    ...
    protected $message  =   [
		...
		'scope.chs'=>'授权范围-描述 包含非法字符-只能是/汉字',
		'scope.chsAlphaNum'=>'授权范围-描述 包含非法字符-只能是/汉字/字母/数字',
		'scope.chsDash'=>'授权范围-描述 包含非法字符',
		'scope.alpha'=>'授权范围-描述 包含非法字符-只能是/字母',
		'scope.alphaNum'=>'授权范围-描述 包含非法字符-只能是/字母/数字',
		'scope.alphaDash'=>'授权范围-描述 包含非法字符',
		'scope.length'=>'授权范围-描述 最大长度是 255',
