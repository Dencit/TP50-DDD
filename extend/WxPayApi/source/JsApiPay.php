...
class JsApiPay
{
	 ...
	 */
	public function GetSmallParameters($UnifiedOrderResult)
	{
	 ...
	 * @throws WxPayException
	 */
	public function GetMWEBParameters($UnifiedOrderResult)
	{
		if(!array_key_exists("appid", $UnifiedOrderResult)
		|| !array_key_exists("prepay_id", $UnifiedOrderResult)
		|| $UnifiedOrderResult['prepay_id'] == "")
		...
		$data = [
			...
			"trade_type"=>$UnifiedOrderResult['trade_type'],
			"sign"=>$UnifiedOrderResult['sign']
		];
		//$data = $UnifiedOrderResult;//
